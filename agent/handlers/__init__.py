...
from . import (
    app_admin, files, git_ops, host, machine, ollama, ping, repo_admin,
    run_command, self_update, services, status, telegram_admin, watchdog_admin,
)
...
REGISTRY: dict[str, Handler] = {
    ...
    "run_command": run_command.handle_run_command,
    "ping": ping.handle_ping,
    "watchdog_stats": watchdog_admin.handle_watchdog_stats,
